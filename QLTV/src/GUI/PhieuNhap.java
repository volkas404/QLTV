...
//				});
				...
				scrollPane_1.setBounds(15, 321, 487, 192);
				...
				txtpnTmKim.setText("Tìm kiếm sách");
				txtpnTmKim.setBounds(42, 13, 88, 20);
				panel.add(txtpnTmKim);
				
				JPanel panel_4 = new JPanel();
				panel_4.setBackground(Color.WHITE);
				panel_4.setBounds(10, 71, 347, 162);
				panel.add(panel_4);
				panel_4.setBorder(new TitledBorder(null, "Nhập sách", TitledBorder.LEADING, TitledBorder.TOP, null, null));
					...
					txtsoluong.setBounds(125, 116, 164, 20);
					...
					txtpnMNcc.setBounds(10, 84, 82, 20);
					...
					txttensach.setBounds(125, 85, 164, 20);
					...
					txtpnSLng.setBounds(10, 115, 112, 20);
					...
					panel_4_1.setBounds(512, 321, 249, 192);
					panel.add(panel_4_1);
					...
					btnthem.setBounds(10, 76, 118, 38);
					...
					btnNewButton_4_1.setBounds(10, 124, 118, 40);
