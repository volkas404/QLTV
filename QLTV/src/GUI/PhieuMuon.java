...
public class PhieuMuon extends JPanel {
	...
	public PhieuMuon() {
	    ...
	    btnNewButton_2_3.setBounds(165, 73, 94, 39);
	    ...
	    JButton btnNewButton_2_3_1 = new JButton("Tạo Phiếu Mượn");
	    ...
	    btnNewButton_2_3_1.setBounds(20, 123, 135, 40);
	    ...
	    btnexport.setBounds(165, 123, 94, 40);
	    ...
	    btnThempm.setBounds(20, 73, 135, 39);
	    		...
	    		if(table.getRowCount()>0) {
	    			for(int j=0;j<table.getRowCount();j++) {
	    				if(table.getValueAt(j, 2).toString().equals(txttensach.getText())) {
	    					JOptionPane.showMessageDialog(null,"Bạn đã mượn sách này rồi");
	    					return;
	    				}
	    			}
	    		}
	    ...
	    separator_2.setBackground(SystemColor.scrollbar);
	    ...
	    JLabel lblNewLabel_1 = new JLabel("Phiếu Mượn");
	    ...
	    lblNewLabel_1_1.setBounds(489, 11, 154, 32);
